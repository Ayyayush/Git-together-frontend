...
const Navbar = () => {
  ...
  // Explicit state for profile dropdown.
  // Do not rely on DaisyUI :focus-within behavior.
  ...
  useEffect(() => {
    ...
    const fetchInitialNotifications = async () => {
      try {
        ...
        console.error(
          "Failed structural loading of notification metadata stream",
          err
        );
      }
    };
  ...
  const toggleProfileDropdown = () => {
    ...
    // Avoid both dropdowns being open simultaneously.
    setShowNotifDropdown(false);
  };
      ...
      >
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          {user ? (
            <>
              {/* ================= DESKTOP QUICK NAV ================= */}
              <div className="hidden lg:flex items-center gap-0.5 mr-1 pr-1.5 border-r border-white/10">
                <button
                  type="button"
                  onClick={() => {
                    closeProfileDropdown();
                ...
                >
                  <FaHome className="text-gray-300" size={15} />
                </button>
                ...
                <button
                  ...
                  className="btn btn-ghost btn-circle hover:bg-white/10 transition-colors"
                >
                  <FaHandshake className="text-gray-300" size={15} />
                </button>
                ...
                <button
                  ...
                  className="btn btn-ghost btn-circle hover:bg-white/10 transition-colors"
                >
                  <FaUsers className="text-gray-300" size={15} />
                </button>
              </div>
                        ...
                        notifications.slice(0, 15).map((notif) => (
                          <div
                            ...
                            className={`flex items-start gap-3 p-3 rounded-xl cursor-pointer transition-all duration-200 ${
                              notif.isRead
                                ? "hover:bg-white/[0.04] opacity-75"
                                : "bg-white/[0.03] border-l-2 border-indigo-500 hover:bg-white/[0.06]"
                            }`}
                          >
            ...
            <div ref={profileContainerRef} className="relative">
              ...
              >
                <div className="relative">
                  <div
                    className={`w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center text-white font-semibold text-sm ${
                      user.isPremium
              ...
              {/* PROFILE MENU */}
              {showProfileDropdown && (
                <ul className="absolute right-0 top-full mt-3 menu w-60 rounded-2xl bg-base-100 text-base-content backdrop-blur-xl border border-base-300 shadow-2xl shadow-black/50 p-2 z-[999]">
                  <li className="px-3 pt-2 text-sm font-semibold truncate">
                    {user.firstName || user.emailId}
                  </li>

                  <li
                    className={`px-3 pb-2 text-xs font-medium tracking-wide ${
                      user.isPremium
                        ? "text-yellow-400"
                        : "text-gray-500"
                    }`}
